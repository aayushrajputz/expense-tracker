...
DROP TABLE IF EXISTS bank_links CASCADE;
...
-- Create indexes for deleted_at columns (for soft deletes)
CREATE INDEX idx_users_deleted_at ON users(deleted_at);
CREATE INDEX idx_bank_links_deleted_at ON bank_links(deleted_at);
CREATE INDEX idx_transactions_deleted_at ON transactions(deleted_at);
CREATE INDEX idx_category_overrides_deleted_at ON category_overrides(deleted_at);