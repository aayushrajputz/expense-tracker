...
import (
	...
	"expense-tracker-backend/internal/core/domain"
...
func (h *AuthHandler) Register(c *gin.Context) {
	...
	if err == nil && existingUser != nil {
		c.JSON(http.StatusConflict, ErrorResponse{Error: "An account with this email already exists. Please try logging in instead."})
		return
	}
