      ...
      <div className="max-w-md w-full space-y-8 p-10 bg-[#1a1a1a]/80 backdrop-blur-xl rounded-3xl border border-[#333333]/50 shadow-2xl relative z-10">
        ...
        <div className="text-center">
          ...
          <p className="text-[#808080]">
            ...
            <Link href="/login" className="font-semibold text-[#00FFFF] hover:text-[#FFD700] cursor-pointer transition-all duration-300 hover:underline">
              Sign In
            </Link>
          </p>
        </div>
        ...
        <form className="mt-10 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-5">
            ...
            <div>
              <label htmlFor="confirmPassword" className="text-sm font-semibold text-[#e0e0e0] block mb-3 tracking-wide">
                CONFIRM PASSWORD
              </label>
              <input
                id="confirmPassword"
